...
function CustomChefDrawerContent(props: any) {
...
export default function ChefDrawerLayout() {
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      <Drawer
        drawerContent={(props) => <CustomChefDrawerContent {...props} />}
        screenOptions={{
      ...
      >
        ...
        <Drawer.Screen 
          ...
          options={{ 
            title: 'Configuración',
            drawerLabel: 'Ajustes',
            drawerIcon: ({ color }) => <Ionicons name="options-outline" size={24} color={color} /> 
          }} 
        />
      </Drawer>
