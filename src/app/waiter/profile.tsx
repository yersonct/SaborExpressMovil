      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.headerCard}>
          ...
          <View style={styles.roleBadge}>
            <Text style={styles.roleText}>MESERO SR.</Text>
          </View>
        </View>
        ...
        <View style={styles.qrSection}>
          ...
          <View style={styles.qrCard}>
            ...
            <Text style={styles.qrText}>ID: MES-48291</Text>
            <Text style={styles.qrInstruction}>Muestra este código para iniciar turno o replazar a un compañero</Text>
          </View>
        </View>
        ...
        <View style={styles.metricsSection}>
          ...
          <View style={styles.metricsRow}>
            <View style={styles.metricCard}>
              <Ionicons name="restaurant-outline" size={28} color="#E61C24" />
              <Text style={styles.metricValue}>12</Text>
              <Text style={styles.metricLabel}>Mesas Atendidas</Text>
            </View>
            <View style={styles.metricCard}>
        ...
        <View style={styles.shiftSection}>
          ...
          <View style={styles.shiftCard}>
            <View style={styles.shiftRow}>
              ...
              <Text style={styles.shiftValue}>08:00 AM</Text>
            </View>
            <View style={styles.shiftDivider} />
            <View style={styles.shiftRow}>
              <Ionicons name="log-out-outline" size={20} color="#64748B" />
              <Text style={styles.shiftLabel}>Hora de Salida:</Text>
              <Text style={styles.shiftValue}>04:00 PM</Text>
            </View>
            <View style={styles.shiftDivider} />
            <View style={styles.shiftRow}>
              <Ionicons name="calendar-outline" size={20} color="#E61C24" />
              <Text style={styles.shiftLabel}>Día de Descanso:</Text>
              <Text style={styles.shiftValue}>Lunes</Text>
            </View>
          </View>
          <Text style={styles.footerNote}>* Para modificar estos datos, comunícate con Administración.</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  profilePic: { width: 90, height: 90, borderRadius: 45, marginBottom: 15, borderWidth: 3, borderColor: '#F1F5F9' },
