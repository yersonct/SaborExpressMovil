      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.headerCard}>
          <View style={styles.profilePicFallback}>
            <Ionicons name="calculator" size={45} color="#1E293B" />
          </View>
          <Text style={styles.name}>Cajero Principal</Text>
          <View style={styles.roleBadge}>
            <Text style={styles.roleText}>CAJA REGISTRADORA</Text>
          </View>
        </View>
        ...
        <View style={styles.metricsSection}>
          ...
          <View style={styles.metricsRow}>
            <View style={styles.metricCard}>
              ...
              <Text style={styles.metricLabel}>Mesas Cobradas</Text>
            </View>
            <View style={styles.metricCard}>
        ...
        <View style={styles.shiftSection}>
          ...
          <View style={styles.shiftCard}>
            ...
            <View style={styles.shiftRow}>
              <Ionicons name="desktop-outline" size={20} color="#EA1D2C" />
              <Text style={styles.shiftLabel}>Estación Asignada:</Text>
              <Text style={styles.shiftValue}>Caja Principal</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  profilePicFallback: { width: 90, height: 90, borderRadius: 45, marginBottom: 15, borderWidth: 3, borderColor: '#F1F5F9', backgroundColor: '#EFF6FF', justifyContent: 'center', alignItems: 'center' },
  name: { fontSize: 24, fontWeight: '900', color: '#1E293B', marginBottom: 5 },
  roleBadge: { backgroundColor: '#FEF2F2', paddingHorizontal: 15, paddingVertical: 5, borderRadius: 20, borderWidth: 1, borderColor: '#EA1D2C' },
  roleText: { color: '#EA1D2C', fontSize: 12, fontWeight: 'bold', letterSpacing: 1 },
